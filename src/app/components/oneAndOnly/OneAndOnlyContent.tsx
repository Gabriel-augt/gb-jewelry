...
export default function OneAndOnlyContent() {
  return (
    <section
      className="flex flex-row items-center justify-center gap-72 w-full h-max pt-6 pb-28
        max-xl:flex-col-reverse max-xl:gap-12">
      <div className="absolute left-0 -translate-y-60 max-xl:-translate-y-[520px]
      max-xl:w-80 max-lg:w-64 max-sm:-translate-y-[440px]">
      ...
      max-lg:w-64 max-sm:-translate-y-[450px] max-sm:w-48">
        <Image src={"particles-2.svg"} alt="Particles" width={410} height={345}/>
      </div>
      <div className="relative max-xl:-translate-x-7 max-md:-translate-x-20">
        ...
        <Image
          ...
          max-md:w-72 max-md:-translate-y-56 max-md:translate-x-28"
      ...
      <div className="flex flex-col gap-4 z-10">
        ...
        <h1 className="font-eb-garamond text-5xl w-[420px] max-sm:text-3xl max-sm:w-96">
          Estilo verdadeiramente único
        </h1>
        <p className="font-inter font-light text-lg w-64 max-sm:text-base">
