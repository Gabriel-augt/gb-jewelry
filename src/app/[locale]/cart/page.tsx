  ...
  return (
    ...
    max-lg:flex-col max-lg:items-center max-lg:gap-0">
      <div className=" flex flex-col">
        <div className="flex flex-col">
          <Link href={"/"}>
            <button className="flex flex-row items-center gap-1 font-semibold -translate-x-2 p-2 my-3 rounded-md cursor-pointer hover:bg-gray-100">
              <ArrowLeft size={20} />
        ...
        gap-8 border border-gray-200 rounded-md overflow-y-auto h-[500px] mb-8 w-[520px]">
          <div className="flex flex-col font-eb-garamond text-xl h-max">
            <div className="flex flex-col divide-y divide-gray-200 rounded-xl px-8">
              {cartItems.map((item: any) => (
                <div key={item.id}
                  className="flex flex-row justify-center gap-20 py-6">
                  <div className="flex flex-col items-center gap-3">
                    <Image
                      ...
                      height={360}
                    />
                    <span className="font-semibold tracking-wide w-36 text-center text-lg">
                      {item.name}
                    </span>
                  </div>
